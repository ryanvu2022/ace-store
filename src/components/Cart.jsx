      ...
      <div className="min-h-screen w-[90vw] mx-auto my-0 px-0 py-10 max-w-4xl">
         ...
         ? <>
            ...
            <footer className="flex flex-col">
               ...
               <button className="transition-all duration-300 ease-linear mt-4 text-darkgreen bg-white hover:text-white hover:bg-darkgreen text-xl items-center font-medium rounded border-2 border-solid border-darkgreen ss:w-2/5 w-52 mx-auto py-2 tracking-widest" onClick={() => {
